...
class WalletHome extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            non_offers: [],
            api_offers: [],
            api_url: 'https://api.theworldmarketplace.com',
            offer_loading_flag: '',
 ...
 */
    ...
    select_merchant_user = async (username, index) => {
        ...
        try {
            ...
            if (is_user.error) {
                ...
                this.fetch_messages_seller(username, 'https://api.theworldmarketplace.com');
    ...
    register_twmapi = async (user, twm_api_url = 'https://api.theworldmarketplace.com') => {
        try {
            let twm_file = this.state.twm_file;
    ...
    title_chars_change = (e) => {
        e.preventDefault();
        this.setState({title_chars: e.target.value.length});
    }
                        ...
                        <div className="home-main-div">
                            <Col sm={4}
                                ...
                                <HomeInfo
                                    ...
                                    stakedTokens={this.state.unlocked_stake}
                                />
                            ...
                            try {
                                ...
                                rowContents.push(
                                    <Col md={3} key={key}>
                                        ...
                                        <div style={{width: '150px'}}>quantity: {listing.quantity}</div>

                                        <div style={{width: '100px'}}>seller: {listing.username}</div>
                    ...
                    return (
                        <div className="">
                            ...
                            {this.state.showBuyerOrders ?
                                ...
                                :
                                    <div style={{marginLeft: '10%', width: '80%', maxHeight: '550px', overflowY: 'scroll', background: 'white'}}>
                                        {table_of_listings ||
